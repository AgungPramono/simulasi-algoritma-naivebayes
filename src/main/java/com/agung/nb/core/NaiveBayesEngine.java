...
public class NaiveBayesEngine {
    ...
    private void hitungJumlahLabel() {
        ...
        resultOutput.append("C1(Class 1) --> Klasifikasi = LANCAR --> ").append(jumlahLancar).append("\n");
        resultOutput.append("C1(Class 2) --> Klasifikasi = MACET --> ").append(jumlahMacet).append("\n");
        resultOutput.append("Total = ").append(total).append("\n\n");
        resultOutput.append("---------------------------------------------------------------\n\n");
        resultOutput.append("Maka" + "\n");
        resultOutput.append("P(C1) = ").append(jumlahLancar).append(" / ").append(total).append(" = ").append(classLancar).append("\n");
        resultOutput.append("P(C2) = ").append(jumlahMacet).append(" / ").append(total).append(" = ").append(classMacet).append("\n\n");
    }
    ...
    public void hitungJumlahClassByKasus(String penghasilan, String status, String pinjaman, String statusRumah, String pekerjaan) {
        resultOutput.append("STUDI KASUS \n");
        resultOutput.append("-------------------------------------------------------------------\n");
        resultOutput.append("Penghasilan\t\t: ").append(penghasilan).append("\nStatus\t\t\t: ").append(status).append("\nStatus Rumah\t\t: ")
                .append(statusRumah).append("\nPinjaman\t\t: ").append(pinjaman).append("\nPekerjaan\t\t: ").append(pekerjaan).append("\n");
        resultOutput.append("Klasifikasi\t\t: Macet atau Lancar ?");
        resultOutput.append("\n--------------------------------------------------------------------\n\n");
        ...
        resultOutput.append("Naive Bayes Classifier\n");
        resultOutput.append("--------------------------------------------------\n\n");
        resultOutput.append("P(penghasilan = ").append(penghasilan).append("|Klasifikasi=LANCAR)= ").append(penghasilan1).append("\n");
        resultOutput.append("P(penghasilan = ").append(penghasilan).append("|Klasifikasi=MACET)= ").append(penghasilan2).append("\n");
        resultOutput.append("P(status = ").append(status).append("|Klasifikasi=LANCAR) = ").append(status1).append("\n");
        resultOutput.append("P(status = ").append(status).append("|Klasifikasi=MACET) = ").append(status2).append("\n");
        resultOutput.append("P(status Rumah = ").append(statusRumah).append("|Klasifikasi=LANCAR) = ").append(statusRumah1).append("\n");
        resultOutput.append("P(status Rumah = ").append(statusRumah).append("|Klasifikasi=MACET) = ").append(statusRumah2).append("\n");
        resultOutput.append("P(Pinjaman = ").append(pinjaman).append("|Klasifikasi=LANCAR)= ").append(pinjaman1).append("\n");
        resultOutput.append("P(Pinjaman = ").append(pinjaman).append("|Klasifikasi=MACET) = ").append(pinjaman2).append("\n");
        resultOutput.append("P(Pekerjaan = ").append(pekerjaan).append("|Klasifikasi=LANCAR) = ").append(pekerjaan1).append("\n");
        resultOutput.append("P(Pekerjaan = ").append(pekerjaan).append("|Klasifikasi=MACET) = ").append(pekerjaan2).append("\n\n");

        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("\tAttribut \t\t\t\t\t\tClass/Label\n");
        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("\t\t\t\t\t\tLANCAR\t\t\t\tMACET\n");
        resultOutput.append("===============================================================================================\n");
        resultOutput.append("Penghasilan\n");
        resultOutput.append("::").append(penghasilan).append("\t\t\t\t\t").append(jmlPenghasilanClassLancar).append("\t\t\t")
                .append(jmlPenghasilanClassMacet).append("\n");

        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("Status\n");
        resultOutput.append("::").append(status).append("\t\t\t\t").append(jmlStatusClassLancar).append("\t\t\t").append(jmlStatusClassMacet)
                .append("\n");

        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("Status Rumah\n");
        resultOutput.append("::  ").append(statusRumah).append("\t\t\t\t").append(jmlStatusRmClassLancar).append("\t\t\t")
                .append(jmlStatusRmClassMacet).append("\n");

        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("Pinjaman\n");
        resultOutput.append("::  ").append(pinjaman).append("\t\t\t\t").append(jmlPjmClassLancar).append("\t\t\t").append(jmlPjmClassMacet)
                .append("\n");

        resultOutput.append("-----------------------------------------------------------------------------------------------\n");
        resultOutput.append("Pekerjaan\n");
        resultOutput.append("::   ").append(pekerjaan).append("\t\t\t\t").append(jmlPkrjaanClassLancar).append("\t\t\t").append(jmlPkrjaanClassMacet)
                .append("\n");
        resultOutput.append("===============================================================================================\n\n");
        ...
        resultOutput.append("LANCAR\t= ").append(jmlPenghasilanClassLancar).append(" * ").append(jmlStatusClassLancar).append(" * ")
        ...
        resultOutput.append("MACET\t= ").append(jmlPenghasilanClassMacet).append(" * ").append(jmlStatusClassMacet).append(" * ")
        ...
        setOutput(resultOutput.toString());
    }
    ...
    private void cariNilaiMax(double lancar, double macet) {
        ...
        resultOutput.append("Nilai Maximal Lancar = ").append(lancar).append(" * ").append(classLancar).append(" = ").append(nilaiMaxLancar).append("\n");
        resultOutput.append("Nilai Maximal Macet = ").append(macet).append(" * ").append(classMacet).append(" = ").append(nilaiMacMacet).append("\n");
    }
